...
def PPO_train(env, sizes, activations, storage, lr, max_grad_norm, frames_per_batch, total_frams, sub_batch_size = 64, 
        num_epochs = 10, clip_epsilon = 0.2, gamma = 0.99, lmbda = 0.95, entropy_eps = 1e-4):
    ...
    base_env = GymEnv(env, device=device)
...
def DQN_train(env, network_size, activations, Storage, LR, frames_per_batch, total_frams, 
            gamma = 0.99, tau = 0.01, EPS_START=1, EPS_END=0.1, EPS_DECAY=100_000):
